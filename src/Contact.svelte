...
<div class="bg-gray-800 text-gray-100 px-8 py-12">
  ...
  <div
    class="max-w-screen-xl mt-24 px-8 grid gap-8 grid-cols-1 md:grid-cols-2
    md:px-12 lg:px-16 xl:px-32 py-16 mx-auto bg-gray-100 text-gray-900
    ...
    <div class="">
      <div>
        ...
        <input
          class="w-full bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg
      ...
      <div class="mt-8">
        ...
        <textarea
          class="w-full h-32 bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg
          focus:outline-none focus:shadow-outline" />
      </div>
      <div class="mt-8">
        <button
          class="uppercase text-sm font-bold tracking-wide bg-indigo-500
          text-gray-100 p-3 rounded-lg w-full focus:outline-none
